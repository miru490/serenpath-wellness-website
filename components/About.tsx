...
export function About() {
  return (
    <section id="about" className="section-padding bg-[#f3ece4] px-5 md:px-6">
      <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="relative">
          <div className="soft-card rounded-[2rem] p-5">
            <div className="relative h-80 overflow-hidden rounded-[1.5rem] md:h-[460px]">
              <Image
              ...
              <div className="absolute inset-x-5 bottom-5 rounded-2xl bg-white/72 p-5 backdrop-blur-md">
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#a98467]">
                  Visual Direction
                </p>
          ...
          <div className="absolute -right-5 top-10 hidden rounded-2xl bg-[#8faf9f] px-5 py-4 text-white shadow-xl shadow-[#2f2a26]/10 md:block">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h2 className="font-display max-w-2xl text-5xl font-semibold leading-tight tracking-tight md:text-6xl">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-[#e0d4c7] bg-[#faf7f2]/70 p-5">
              <p className="font-semibold">Designed for action</p>
              <p className="mt-2 text-sm leading-6 text-[#6f625a]">
                Visitors can quickly understand the offer and make contact.
              </p>
            </div>
          </div>
        </div>
